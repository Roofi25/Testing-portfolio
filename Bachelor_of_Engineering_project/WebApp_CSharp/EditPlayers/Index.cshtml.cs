...
namespace System_wspomagajacy_organizacje_wydarzen_sportowych.Pages.EditPlayers
{
    public class IndexModel : PageModel
    {
		...
		public IList<int> WybraneZawody { get; set; } = new List<int>();
		...
		public void OnGet(int id)
		{
			...
			try
			{
				using (SqlConnection connection = new SqlConnection(connectionString))
				{
					...
					HttpContext.Session.SetString("akcja", "edytowaæ");
